...
* Variables
  ...
  | =emissions_category_hover=            | t1b6                         | =list=    | List of emissions hover texts =['Hover text cat 1','Hover text cat2','Hover text cat 3','Hover text cat 4','Hover text cat 5','Hover text cat 6']= |
