...
printable_columns = ['company_name', 'global_score_pic', 'c1_label', 'c2_label', 'c1_color', 'c2_color']
    ...
    for i in range(0, max_rows):
        ...
        rows.append(
            html.Tr([
                ...
                html.Td(html.Img(src=image_filename), className="me-1 p-1 text-start"),
                html.Td('\u279c ' + df.iloc[i]['c1_label'], className="px-2", style={'color': df['c1_color'][i]}),
                html.Td('\u279c ' + df.iloc[i]['c2_label'], className="px-2", style={'color': df['c2_color'][i]})
            ],
                    id=str(i),
                    className=""))
        ...
        html.Div([
            html.Table([
                ...
                html.Tbody(rows)
                       ...
                       className="align-middle table table-borderless table-bordered text-center mb-0")
        ],
